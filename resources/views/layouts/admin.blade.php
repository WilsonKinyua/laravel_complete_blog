                    ...
                    <div class="collapse navbar-collapse" id="navigation">
                        <ul class="navbar-nav ml-auto">
                            <li class="search-bar input-group">
                                <button class="btn btn-link disabled" id="search-button" data-toggle="modal" data-target="#searchModal"><i
                  ...
                  <span class="d-lg-none d-md-block">Search</span>
                            ...
                            <li class="dropdown nav-item">
                                <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                                    <div class="photo">
                                        <img src="{{auth()->user()->photo ? auth()->user()->photo->file : Gravatar::src(auth()->user()->email)}}" alt="Profile Photo">
                                    </div>
                                ...
                                <ul class="dropdown-menu dropdown-navbar">
                                    <li class="nav-link"><a href="{{route('user.edit-profile')}}" class="nav-item dropdown-item">Profile</a></li>
            ...
            <footer class="footer">
                ...
                Blog
                    ...
                    <div class="copyright">
                        ...
                        </script> made with <i style="color:red" class="tim-icons icon-heart-2"></i> by 
                        <a href="#" target=""> Software Engineer Wilson </a> for a better web.
                    </div>
                </div>
            </footer>
        </div>
